...
renamed_taxon = [taxon.replace("Nauph75", "Nauph") for taxon in renamed_taxon]
renamed_taxon = [taxon.replace("Nauph77", "Nauph") for taxon in renamed_taxon]
renamed_taxon = [taxon.replace("Nauph80", "Nauph") for taxon in renamed_taxon]
...
renamed_taxon = [taxon.replace("HS2_sc", "HissingRoach") for taxon in renamed_taxon]
